...
router.get('/', (req, res) => {
    ...
    if (input.url.id) {
        let sql = "SELECT * FROM products WHERE pr_id=? ORDER BY pr_id DESC";
        ...
        let sql = "SELECT * FROM products WHERE pr_title LIKE '%" + input.url.key + "%' OR pr_detail LIKE '%" + input.url.key + "%' ORDER BY pr_id DESC"
        ...
        let sql = "SELECT * FROM products ORDER BY pr_id DESC"
